...
Argo data format is an implementation of NetCDF format developed by UCAR/Unidata (http://doi.org/10.5065/D6H70CW6).
...
Data section
History section
Argo data comply with NetCDF Climate and Forecast (CF) Metadata Conventions (version 1.6).
...
HANDBOOK_VERSION:_FillValue = " ";                                                                             | Version number of the data handbook.
...
REFERENCE_DATE_TIME:_FillValue = " "; | Date of reference for Julian days.
...
DATE_CREATION:_FillValue = " ";                                     | Date and time (UTC) of creation of this file.
...
DATE_UPDATE:_FillValue = " ";                                       | Date and time (UTC) of update of this file.
