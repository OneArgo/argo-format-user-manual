...
The parameters are described in reference table 3 (https://vocab.nerc.ac.uk/collection/R03/).
Example : PSAL
HISTORY_START_PRES
...
Stop pressure the action is applied to.
This should be greater than or equal to  START_PRES.
Example : 1757.0
