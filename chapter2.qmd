...
**Example**
![](assets/images/float-cycle-mission.png)

In the above example, there are 3 different float behaviors to record, (with park depth varying between 1500, 2000 and 1700 db).<br>Each of these new behaviors requires a new mission number.  
This is in addition to the pre-deployment or launch information:  
...
| LAUNCH\_LATITUDE  | not empty, -90 <= real <= 90  | LAUNCH\_LATITUDE = -7.91400003433228;|
| LAUNCH\_LONGITUDE  | not empty, -180 <= real <= 180  | LAUNCH\_LONGITUDE = -179.828338623047;|
...
| PLATFORM\_MAKER | see reference table 24 (<https://vocab.nerc.ac.uk/collection/R24/>).  | PLATFORM\_MAKER = “Optimare”; |
