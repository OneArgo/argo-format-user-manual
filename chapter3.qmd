...
* The C\_Format, Fortran\_Format and Format\_resolution attributes are float/sensor dependents. They are set by the DAC (Data Assembly Centre).
...
### How to indicate multiple sensors for the same parameter
...
- Use DOXY and TEMP\_DOXY for Optode

- Use DOXY\_2 for SBE

If a float has two Optode oxygen sensors:

- Use DOXY and TEMP\_DOXY, and DOXY\_2 and TEMP\_DOXY\_2

If a float has four SBE oxygen sensors:

- Use DOXY, DOXY\_2, DOXY\_3, DOXY\_4
