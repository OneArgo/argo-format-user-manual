...
**File naming convention**B\<R/D>\<FloatWmoID>\_\<XXX>\<D>.nc * B : B-Argo file prefix
...
**File naming convention**M\<R/D>\<FloatWmoID>\_\<XXX>\<D>.nc * M : merged B-Argo file prefix

* \<R/D>\<FloatWmoID>\_\<XXX>\<D>.nc : identical to Core-Argo file naming conventionExamples: MR1900045\_083.nc, MR1900045\_083D.nc, MD1900045\_003.nc

### Argo trajectory data file

The Argo trajectory files contain the core and BGC parameters provided by a float.\<FloatWmoID>\_\<R/D>traj.nc* R: real-time data

* D: delayed-mode data<br>
**Examples**1900045\_Rtraj.nc : real-time trajectory from float 19000451900045\_Dtraj.nc : delayed-mode trajectory from float 1900045
